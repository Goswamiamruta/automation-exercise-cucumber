...
import com.automationexercise.pages.ExtraPage;
...
public class RegisterSteps {
    ...
    public void enterNameAndEmailAddress() {
        ...
        new LoginPage().enterName("Amruta");
        new LoginPage().enterEmail("Jeet" + randomInt + "@gmail.com");
    ...
    public void enterNameAndAlreadyRegisteredEmailAddress() {
        new LoginPage().enterName("Amruta");
        new LoginPage().enterEmail("Amruta123@gmail.com");
    }
